...
do
    if [ $mem -eq 1 ]
    then
       wget ftp://ftp.ncep.noaa.gov/pub/data/nccf/com/nwm/prod/nwm.20181216/long_range_mem1/
    elif [ $mem -eq 2 ]
    then
       wget ftp://ftp.ncep.noaa.gov/pub/data/nccf/com/nwm/prod/nwm.20181211/long_range_mem2/
    elif [ $mem -eq 3 ]
    then
       wget ftp://ftp.ncep.noaa.gov/pub/data/nccf/com/nwm/prod/nwm.20181210/long_range_mem3/
    elif [ $mem -eq 4 ]
    then
       wget ftp://ftp.ncep.noaa.gov/pub/data/nccf/com/nwm/prod/nwm.20181210/long_range_mem4/         
    fi
    ...
    do   
        outname="/***Please use your own route***/""${myfile[$count]:100:8}""${myfile[$count]:128:6}""${myfile[$count]:145:26}""
    ...
    until [ $count -gt $index ]
    do   
        outname="/***Please use your own route***/""${myfile[$count]:100:8}""${myfile[$count]:128:6}""${myfile[$count]:145:20}""
